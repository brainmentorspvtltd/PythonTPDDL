...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_14.setGeometry(QtCore.QRect(670, 320, 181, 61))
        ...
        self.pushButton_16.setGeometry(QtCore.QRect(560, 320, 71, 61))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.buttons = [self.pushButton, self.pushButton_2, self.pushButton_3,
                        ...
                        self.pushButton_13,self.pushButton_16
                        ]
    ...
    def calc(self):
        ...
        self.expression.append(btn_value)
        self.lineEdit.clear()
        for data in self.expression:
            self.lineEdit.setText(self.lineEdit.text() + data)

    def evaluate(self):
        to_eval = self.lineEdit.text()
        result = eval(to_eval)
